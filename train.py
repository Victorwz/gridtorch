...
tf.flags.DEFINE_integer('training_evaluation_minibatch_size', 100,
...
tf.flags.DEFINE_string('stored_session',
                                             'None',
                                             'grabs a stored session to continue training')

# Store
tf.flags.DEFINE_string('saver_results_directory',
                       None,
                       'Path to directory for saving results.')
tf.flags.DEFINE_integer('saver_eval_time', 10,
    ...
    with tf.train.SingularMonitoredSession() as sess:
        ...
        for epoch in range(start_epoch, FLAGS.training_epochs):
            ...
            if epoch % FLAGS.saver_eval_time == 0:
                ...
                filename = 'rates_and_sac_latest_hd_epoch_{}.pdf'.format(epoch)
